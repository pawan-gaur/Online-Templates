...
<div class="footer-top">
	<div class="container">
		<div class="col-md-6 footer-left wow fadeInLeft" data-wow-delay=".5s">
			<h3>Bus Operators</h3>
			<ul>
				...
				<li><a href="#">ASTC</a></li>
				<li><a href="#">JKSRTC</a></li>
				<li><a href="#">OSRTC</a></li>
				<li><a href="#">RSRTC</a></li>
				<li><a href="#">UTC</a></li>
				<li><a href="#">GSRTC</a></li>
				<li><a href="#">KTCL</a></li>
				<li><a href="#">PEPSU</a></li>
				<li><a href="#">SBSTC</a></li>
				<li><a href="#">WBTC</a></li>
				<div class="clearfix"></div>
			</ul>
		</div>
		<div class="col-md-6 footer-left wow fadeInRight" data-wow-delay=".5s">
			<h3>Bus Routes</h3>
			<ul>
				...
				<li><a href="#">Delhi To Jammu Bus</a></li>
				<li><a href="#">Mumbai To Pune Bus</a></li>
				<li><a href="#">Delhi To Dehradun Bus</a></li>
				<li><a href="#">Delhi To Dharamshala Bus</a></li>
				<li><a href="#">Pune To Mumbai Bus</a></li>
				<li><a href="#">Delhi To Agra Bus</a></li>
				<li><a href="#">Delhi To Chandigarh Bus</a></li>
				<li><a href="#">Pune To Goa Bus</a></li>
				<li><a href="#">Delhi To Lucknow Bus</a></li>
				<li><a href="#">Delhi To Rishikesh Bus</a></li>
				<li><a href="#">Pune To Shirdi Bus</a></li>
				<div class="clearfix"></div>
			</ul>
		</div>
		<div class="clearfix"></div>
					...
					<div class="writ">
						...
						<script>
							function saveWriteUs(){
								var writeus = {};
								writeus.name = $("#name").val();
								writeus.email = $("#email").val();
								writeus.mobile = $("#mobile").val();
								writeus.issue = $("#issue").val();
								writeus.description = $("#description").val();
								$.ajax({
									url : "saveWriteUs",
									method : "POST",
									data : JSON.stringify(writeus),
